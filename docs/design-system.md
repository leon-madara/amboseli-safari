...
--space-container-padding: var(--space-6);   /* Mobile container padding */
--space-container-padding-md: var(--space-8); /* Tablet container padding */
--space-container-padding-lg: var(--space-12); /* Desktop container padding */
...
- SearchBar
- Card (Base, Image Card, Info Card)
- Accordion Item
- Tab
- Breadcrumb
- Pagination Item
...
Use this reference as the canonical source for design tokens, component inventory, and project organization when evolving the Amboseli Safari Club experience or onboarding new teammates.